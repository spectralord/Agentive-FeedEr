...
| **Ephemere Inhaltsschicht** | Inhalte, die altern und automatisch ausgetauscht/überholt werden dürfen: News-**Reels** und **kuratierte** Experience Reports. |
| **Dauerhafte Wissensschicht** | Inhalte/Zustände, die anwachsen und nie automatisch verworfen werden: **Skill-Nodes**, **user_progress**/**Adoption-Log** und **eigene** Experience Reports. „Dauerhaft" heißt: nicht Teil des automatischen Feed-Churns (manuell archivier-/als-überholt-markierbar), nicht unsterblich. |
| **outdated / superseded** | Manuell setzbare Markierung an einem Inhalt „veraltet", optional mit Begründung und/oder Verweis (`superseded_by`) auf die ablösende neuere Variante. Löschen bleibt immer manuell. |
