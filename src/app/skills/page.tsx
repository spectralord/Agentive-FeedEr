...
// T18.10 (ADR 0023): Skills is a hub — Map · Adoption Log (Knowledge Base
// deliberately omitted, see the epic file's Phase 2 preamble: that surface
// doesn't exist yet). Both sections already live on this one page; the
// sub-nav below is same-page anchor links rather than a route split, per
